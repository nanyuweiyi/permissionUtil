            ...
            public void onClick(View v) {
                PermissionUtil.getInstance().request(new String[]{Manifest.permission.CAMERA},new PermissionResultAdapter() {
                    ...
                    public void onPermissionGranted(String... permissions) {
                        Toast.makeText(SecondActivity.this, permissions[0] + "权限已获得", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onPermissionDenied(String... permissions) {
                        Toast.makeText(SecondActivity.this, permissions[0] + "权限被拒绝", Toast.LENGTH_SHORT).show();
                    }
